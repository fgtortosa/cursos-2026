...
Esta sección cubre las **sesiones 7 a 11** del curso, dedicadas a Vue 3 con TypeScript. Continúa tras la [Parte .NET](../02-dotnet/) y precede a la [Integración full-stack](../04-integracion/).
...
| --------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------- | ---------- |
| [Sesión 7: Vue 3, TypeScript y primer componente](./sesiones/sesion-07-vue-typescript-fundamentos/) | Estructura `.vue`, TypeScript básico, reactividad e interpolación   | 1 h 30 min |
