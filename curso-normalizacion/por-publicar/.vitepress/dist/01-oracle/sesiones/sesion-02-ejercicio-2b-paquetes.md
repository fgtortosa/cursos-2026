---
url: /curso-normalizacion/01-oracle/sesiones/sesion-02-ejercicio-2b-paquetes.md
description: >-
  Ejercicio práctico de PL/SQL. Implementar ACTUALIZAR_BLOQUEADO, CREAR de
  horario por día y CREAR de reserva, apoyándose en validaciones reutilizables
  (VALIDAR_TEXTO, VALIDAR_ID_POSITIVO, VALIDAR_FLAG, VALIDAR_FECHAS).
---
