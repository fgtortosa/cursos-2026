---
url: /curso-normalizacion/01-oracle/sesiones/sesion-03-docencia-tablas-vistas.md
description: >-
  Diseño completo del ciclo TRES_TIPO_RECURSO → VRES_TIPO_RECURSO →
  PKG_RES_TIPO_RECURSO sobre el schema real CURSONORMADM. Edición a través de la
  vista (DML directo en vistas key-preserved), CRUD por package con OUT
  P_CODIGO_ERROR/P_MENSAJE_ERROR y gestión de errores normalizada.
---
