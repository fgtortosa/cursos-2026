---
url: /curso-normalizacion/05-avanzadas/sesiones/sesion-21-tests-calidad.md
description: >-
  Tests unitarios con xUnit (controlador + servicio), tests reales contra Oracle
  con SkippableFact e IClassFixture, tests de integración con
  WebApplicationFactory, httpRepl, ActionFilters y naming JSON
---
