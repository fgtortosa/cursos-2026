---
url: /curso-normalizacion/04-integracion/sesiones/sesion-14-api-autenticacion.md
description: >-
  Autenticación CAS/JWT, peticion y HttpApi, interceptores de axios, estados de
  carga reactivos y OpenAPI/Scalar.
---
...
2. Copia la interface del DTO desde la sección *Schemas*.
...
|---|---|---|
| [← Sesión 13: Otros componentes internos](../../../03-vue/sesiones/sesion-13-componentes-ua/) | [Índice del curso](../../../) | [Sesión 15: Validación en todas las capas →](../../../04-integracion/sesiones/sesion-15-validacion/) |
