---
url: /curso-normalizacion/02-dotnet/test/sesion-04/practica-ia-fix.md
description: >-
  Corregir un controlador POST que no respeta los patrones de la sesión 4
  (ControladorBase, Result<T>, CreatedAtAction).
---
