---
url: >-
  /curso-normalizacion/02-dotnet/sesiones/sesion-08-servicios-oracle/solucion-ejercicio-observaciones.md
description: >-
  Cierre del ejercicio de §1.9 conectado a Oracle vía un servicio real, con sus
  dos tests.
---

# Solución del ejercicio §5.6 — Observaciones con servicio + tests (sesión 8)

::: warning ESTO ES LA SOLUCIÓN
Compárala con la tuya **después** de intentarlo. Antes, mira `TiposRecursoServicio` / `RecursosServicio` y deriva el patrón por tu cuenta. La sesión 15-16 (Validación y Errores) sigue desde aquí, así que la nomenclatura tiene que coincidir.
:::
