---
url: /curso-normalizacion/02-dotnet/sesiones/sesion-05-servicios-oracle.md
description: >-
  Arquitectura de capas, Result<T>, ClaseOracleBD3, llamada a paquetes PL/SQL
  desde .NET y primer test xUnit
---
...
### 5.3.3 El mapeo: PascalCase ⇄ SNAKE\_CASE + multiidioma
...
| 3         | Conversión SNAKE\_CASE automática              | `FechaAlta` → busca `FECHA_ALTA`                   |
