---
title: "Sesión 19: Tests y calidad de código"
...
## 19.1 Tests unitarios con xUnit {#tests-unitarios-xunit}
...
### 19.1.1 Dos tipos de test que nos importan
...
### 19.1.2 Tres piezas de infraestructura compartidas entre tests
...
### 19.1.3 Test simulado: `TipoRecursosControllerSimuladoTests` real
...
### 19.1.4 `OracleTestFixture`: una conexión REAL a Oracle, compartida
...
### 19.1.5 Test real: `TiposRecursoServicioRealTests`
...
El ejercicio §5.6 de la **[sesión 6](../../../02-dotnet/sesiones/sesion-06-servicios-oracle/#_5-6-ejercicio-cerrar-observaciones-con-servicio-tests)** te pide replicar este patrón (fake + test simulado + test real con `SkippableFact`) sobre `Observaciones`. La solución completa con los siete ficheros está en [solucion-ejercicio-observaciones.md](../../../02-dotnet/sesiones/sesion-06-servicios-oracle/solucion-ejercicio-observaciones.md).
:::

## 19.2 Tests de integración con `WebApplicationFactory` {#tests-integracion}

::: warning IMPORTANTE
El contenido detallado de esta sección está pendiente de publicación.
:::

## 19.3 httpRepl {#httprepl}

::: warning IMPORTANTE
El contenido detallado de esta sección está pendiente de publicación.
:::

## 19.4 ActionFilters {#actionfilters}

::: warning IMPORTANTE
El contenido detallado de esta sección está pendiente de publicación.
:::

## 19.5 Naming JSON y patrón GET/POST {#naming-json-patron-get-post}
...
| ---------------------------------------------------------------------------------------------------------- | ----------------------------- | --------------------------------------------------------------------------------------- |
| [← Sesión 18: Estado global y persistencia](../../../05-avanzadas/sesiones/sesion-18-estado-persistencia/) | [Índice del curso](../../../) | [Sesión 20: Trabajo con ficheros →](../../../05-avanzadas/sesiones/sesion-20-ficheros/) |
