---
title: "Sesión 15: DataTable de extremo a extremo"
...
## 15.1 Listado simple vs DataTable server-side {#cuando-usar}
...
## 15.3 Lado cliente: vueua-datatable {#cliente}

Pendiente de publicación.

## 15.4 Conectando las dos partes {#conexion}

Pendiente de publicación.

## 15.5 Tarea progresiva del proyecto final {#tarea-pf}
...
|---|---|---|
| [← Sesión 14: Gestión de errores de extremo a extremo](../../../04-integracion/sesiones/sesion-14-errores/) | [Índice del curso](../../../) | [Sesión 16: Internacionalización →](../../../05-avanzadas/sesiones/sesion-16-internacionalizacion/) |
<!-- NAV:END -->
