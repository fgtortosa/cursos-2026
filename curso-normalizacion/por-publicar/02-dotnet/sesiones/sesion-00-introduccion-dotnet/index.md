...
## 0.3 El patrón MVC en nuestras APIs {#mvc-apis}
...
## 0.5 Inyección de dependencias {#inyeccion-dependencias}
...
Con **inyección de dependencias (DI)**, le decimos al contenedor de .NET: _"cuando alguien pida un `IClaseUnidades`, dale una instancia de `ClaseUnidades`"_. El contenedor se encarga de crear y gestionar las instancias.
