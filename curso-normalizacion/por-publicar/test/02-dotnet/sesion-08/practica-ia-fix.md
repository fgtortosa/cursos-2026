---
title: "Práctica IA-fix — Sesión 8"
description: "Corregir un servicio Oracle que no respeta los patrones de la sesión 8 (parametrización, vista de lectura, Result<T> con NotFound)."
outline: deep
---

# Práctica IA-fix — Sesión 8
