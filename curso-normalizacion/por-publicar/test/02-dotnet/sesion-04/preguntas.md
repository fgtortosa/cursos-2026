---
title: "Preguntas — Sesión 4: Introducción a .NET"
...
# Test de autoevaluación — Sesión 4: Introducción a .NET
...
- DTOs, `[ApiController]`, verbos HTTP, validación con DataAnnotations → [Sesión 5](../sesion-05/).
- `ClaseOracleBD3`, mapeo automático, `[Columna]`, `Result<T>`, paquetes PL/SQL → [Sesión 6](../sesion-06/).
