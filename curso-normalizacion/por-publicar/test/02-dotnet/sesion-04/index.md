...
description: Autoevaluación, preguntas, respuestas y práctica IA-fix para la Sesión 4 (Introducción a .NET).
outline: [2, 2]
search: false
---
...
Material de evaluación de la [Sesión 4: Introducción a .NET](../../sesiones/sesion-04-introduccion-dotnet/).
