---
title: "Práctica IA-fix — Sesión 6"
description: "Corregir un servicio Oracle que no respeta los patrones de la sesión 6 (parametrización, vista de lectura, Result<T> con NotFound)."
outline: deep
---

# Práctica IA-fix — Sesión 6
