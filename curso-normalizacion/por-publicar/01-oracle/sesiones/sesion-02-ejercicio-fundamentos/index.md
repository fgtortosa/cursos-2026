---
title: "Ejercicio sesión 2 — Inspección del schema y diseño de un catálogo"
description: Ejercicio práctico de la sesión 2. Inspección del schema CURSONORMADM, análisis de conversiones de tipos, verificación de grants y diseño de un catálogo simple aplicando convenciones, IDENTITY y restricciones CHECK.
outline: [2, 4]
---

# Ejercicio sesión 2 — Inspección del schema y diseño de un catálogo
...
No tocas todavía vistas ni paquetes: eso pertenece al ejercicio de las sesiones 4 y 5.
:::
