CREATE OR REPLACE EDITIONABLE PACKAGE "CURSONORMADM"."PKG_EJERCICIO_PLS" AS
 ...
 -- Dar alta a un tramo horario para un día concreto
  ...
  PROCEDURE CREAR_RESERVA(
    ...
    P_CODIGO_ERROR       OUT NUMBER,
    P_MENSAJE_ERROR      OUT VARCHAR2);
END PKG_EJERCICIO_PLS;
/
CREATE OR REPLACE EDITIONABLE PACKAGE BODY "CURSONORMADM"."PKG_EJERCICIO_PLS" AS
