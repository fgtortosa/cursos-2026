CREATE OR REPLACE EDITIONABLE PACKAGE "CURSONORMADM"."PKG_EJERCICIO_OPM" AS
  TYPE T_CURSOR IS REF CURSOR;

  /* Procedimiento 1: Actualizar el flag BLOQUEADO de un horario por día */
  ...
  /* Procedimiento 2: Crear un nuevo tramo horario para un día específico */
  ...
  /* Procedimiento 3: Crear una nueva reserva con detección de solapamiento */
