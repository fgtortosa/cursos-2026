    ...
    <div class="markdown-copy-buttons">
        <div class="markdown-copy-buttons-inner">
            <button ref="copyBtn" class="copy" @click="copyMarkdown">
                <span v-html="copied ? iconCheck : iconCopy"></span> {{ copyButtonText }}
            </button>
            <button ref="downloadBtn" class="download" @click="downloadMarkdown">
                <span v-html="downloaded ? iconCheck : iconDownload"></span> {{ downloadButtonText }}
            </button>
        </div>
    </div>
</template>
...
// Textos localizados
const copyButtonText = 'Copiar como Markdown'
const downloadButtonText = 'Descargar como Markdown'
